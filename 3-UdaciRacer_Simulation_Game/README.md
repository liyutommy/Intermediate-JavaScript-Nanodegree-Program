# Project: UdaciRacer Simulation Game - Asynchronous Programming with JavaScript
...
- The server is encapsulated into the binary files where some problems exist, so the "start a new game" button does not work!!
...
<img src=".//ScreenShot4.png" alt="ScreenShot4" style="zoom:33%;" />

<img src=".//ScreenShot5.png" alt="ScreenShot5" style="zoom:33%;" />
